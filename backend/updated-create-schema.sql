...
DROP TABLE IF EXISTS deleted_casualties CASCADE;
...
-- ---------------------------------------------------------------------------
-- idempotency_keys (offline sync: cache POST/PUT/DELETE responses for 24h)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- deleted_casualties (offline sync: permanent deletion log for delta sync)
-- ---------------------------------------------------------------------------
...
UNION ALL SELECT 'deleted_casualties', COUNT(*) FROM deleted_casualties;
